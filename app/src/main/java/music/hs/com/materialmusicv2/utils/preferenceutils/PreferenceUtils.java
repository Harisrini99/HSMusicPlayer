package music.hs.com.materialmusicv2.utils.preferenceutils;
...
public class PreferenceUtils {
    ...
    public void readSongs() {
        ...
        if (songsJson != null && songsWithoutShuffleJson != null) {
            ...
            if (songs.size() - 1 < HSMusicApplication.getInstance().getPlayingQueueManager().getSongPosition() || songsWithoutShuffle.size() - 1 < HSMusicApplication.getInstance().getPlayingQueueManager().getSongPosition()) {
    ...
    public void setSongs() {
        ...
        AsyncTask.execute(() -> {
            try {
                Gson gson = new Gson();
                String songsJson = gson.toJson(HSMusicApplication.getInstance().getPlayingQueueManager().getSongs());
                String songsWithoutShuffleJson = gson.toJson(HSMusicApplication.getInstance().getPlayingQueueManager().getSongsWithoutShuffle());
    ...
    public int getSelectedMenu() {
        if (sharedPreferences != null) {
            return sharedPreferences.getInt("SelectedMenu", 0);
        }
        return 0;
    }
    ...
    public void setSelectedMenu(int menu) {
        if (sharedPreferences != null) {
            sharedPreferences.edit().putInt("SelectedMenu", menu).apply();
        }
    }
    ...
    public int getIsReversed() {
        if (sharedPreferences != null) {
            return sharedPreferences.getInt("isReversed", 0);
        }
        return 0;
    }

    public void setIsCircleImage(boolean choice)
    {
        if (sharedPreferences != null) {
            sharedPreferences.edit().putBoolean("isCircleImage", choice).apply();
        }
    }

    public boolean getIsCircleImage() {
        if (sharedPreferences != null) {
            return sharedPreferences.getBoolean("isCircleImage", false);
        }
        return false;
    }
