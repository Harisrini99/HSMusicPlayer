...
import static music.hs.com.materialmusicv2.utils.colorutils.ColorUtils.changeTextInputLayoutHintColor;
...
public class EditMetaDataActivity extends AppCompatActivity implements MediaScannerConnection.MediaScannerConnectionClient {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.save: {
                ...
                if (trackName != null && albumName != null && artistName != null && albumArtistName != null && year != null && lyrics != null) {
        ...
        if (requestCode == 1 && resultCode == Activity.RESULT_OK) {
            if (data != null) {
                ...
                try {
                    ...
                    postToast("1st catch", getApplicationContext(), TOAST_ERROR);
                    e.printStackTrace();
                }
                try {
    ...
    private void changeTagsBeforeWriting(String... str) {
        ...
        if (newTag != null) {
            try {
                ...
                newTag.setField(FieldKey.LYRICS, str[5]);

                //comehere
                //newTag.setField(FieldKey.TITLE, str[5]);
    ...
    public void Search_Data_Online(View view)
    {
        Intent intent = new Intent(EditMetaDataActivity.this,SearchSongOnlineActivity.class);
    ...
    public void delete_picture(View view)
    {
        artwork = null;
        albumArt.setImageResource(R.drawable.ic_blank_album_art);
    }
}