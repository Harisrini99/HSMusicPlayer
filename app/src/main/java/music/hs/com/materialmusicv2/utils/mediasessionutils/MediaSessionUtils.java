package music.hs.com.materialmusicv2.utils.mediasessionutils;
...
import music.hs.com.materialmusicv2.objects.events.controllerevents.SendCurrentPlaybackPosition;
import music.hs.com.materialmusicv2.service.MediaButtonBroadcastReceiver;
import music.hs.com.materialmusicv2.utils.bitmaputils.BitmapUtils;
import music.hs.com.materialmusicv2.utils.bitmaputils.BlurBuilder;

import static music.hs.com.materialmusicv2.utils.bitmaputils.BitmapUtils.drawBitmapBackground;
import static music.hs.com.materialmusicv2.utils.bitmaputils.BitmapUtils.getDominantColors;
...
public class MediaSessionUtils {
    ...
    public void setMetadata(final Context context, final Song song, final int songPosition, final int numberOfSongs) {
            ...
            if (!Thread.interrupted()) {
                ...
                if (!Thread.interrupted()) {
                    ...
                    try {
                        ...
                        int theme = HSMusicApplication.getInstance().getPreferenceUtils().getTheme();
                    ...
                    EventBus.getDefault().postSticky(new MediaSessionData(
                            ...
                            new CurrentPlayingSong(song.getName(), song.getArtist(), song.getAlbum(),song.getId())
                    ));
                }
            }
        });
        ...
        EventBus.getDefault().postSticky(new CurrentPlayingSong(song.getName(), song.getArtist(), song.getAlbum(),song.getId()));
