...
import music.hs.com.materialmusicv2.adapters.SearchAdapter;
...
public class SearchActivity extends AppCompatActivity implements TextWatcher {
    ...
    public void search(String query) {
        ...
        if (searchAdapter == null)
        {
            ...
            {
                if(page == 0)
                    searchAdapter.update(filteredSongList, new ArrayList<>(),new ArrayList<>());
                else if(page == 2)
                    searchAdapter.update(new ArrayList<>(),filteredAlbumList,new ArrayList<>());
                else if(page == 3)
                    searchAdapter.update(new ArrayList<>(),new ArrayList<>(),filteredArtistList);
                else
