...
import music.hs.com.materialmusicv2.adapters.NowPlayingBackgroundAdapter;
import music.hs.com.materialmusicv2.adapters.ZoomOutPageTransformer;
...
public class NowPlayingBackground extends RelativeLayout {
    ...
    private void setUpBackgroundViewPager() {
        ...
        backgroundViewPager.setPageTransformer(false,new ZoomOutPageTransformer());
