package music.hs.com.materialmusicv2.methodcalls;
...
public class MethodCalls {
    public static String get(String urlString) {
        String response = getResponseFromCache(HSMusicApplication.getInstance().getApplicationContext(), urlString);
        if (response != null) {
            return response;
        }
        if (urlString != null) {
            ...
            try {
                ...
                if (statusCode >= 200 && statusCode < 400) {
                    setResponseInCache(HSMusicApplication.getInstance().getApplicationContext(), stringBuilder.toString(), urlString);
                }
