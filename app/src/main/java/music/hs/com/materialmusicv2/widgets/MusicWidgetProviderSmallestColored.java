...
public class MusicWidgetProviderSmallestColored extends AppWidgetProvider {
    ...
    public void onUpdate(final Context context, final AppWidgetManager appWidgetManager, final int[] appWidgetIds) {
        ...
        try {
            HSMusicApplication.getInstance().getWidgetUtils().getSmallestColoredWidgetController().onMetadataChanged(EventBus.getDefault().getStickyEvent(MediaSessionData.class));
        } catch (Exception e) {
            e.printStackTrace();
        }
