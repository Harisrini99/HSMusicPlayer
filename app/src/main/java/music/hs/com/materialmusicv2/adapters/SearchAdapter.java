...
import music.hs.com.materialmusicv2.activities.AlbumActivity;
...
import music.hs.com.materialmusicv2.adapters.diffcallbacks.AlbumDiffCallback;
...
import static music.hs.com.materialmusicv2.utils.controller.Controller.playSingle;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        switch (viewHolder.getItemViewType()) {
            ...
            case 1: {
                ...
                holder.vuMeterView.setVisibility(View.INVISIBLE);
                break;
            }
            case 2: {
        ...
        void OnClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.menu: {
                    ...
                    popupMenu.setOnMenuItemClickListener(item -> {
                        final ArrayList<Song> songs = QueryUtils.getSongsOfAlbum(album.getId(), album.getName(), album.getArtist(), activity.getContentResolver()) ;
                        switch (item.getItemId()) {
                            case R.id.action_play: {
                                playList(songs, 0);
                                break;
            ...
            switch (view.getId()) {
                ...
                case R.id.menu: {
                    ...
                    popupMenu.setOnMenuItemClickListener(item -> {
                        ...
                        final ArrayList<Song> songs = QueryUtils.getSongsOfArtist(activity.getContentResolver(), MediaStore.Audio.Media.TITLE, artist.getName());
                        switch (item.getItemId()) {
                            case R.id.action_play: {
                                playList(songs, 0);
                                break;
