...
import static music.hs.com.materialmusicv2.utils.bitmaputils.BitmapUtils.getBytes;
...
public class QueueWidgetRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public void onDataSetChanged() {
        try {
            songs = new ArrayList<>(HSMusicApplication.getInstance().getPlayingQueueManager().getSongs());
        } catch (Exception e) {
            songs = new ArrayList<>();
        }
    }
