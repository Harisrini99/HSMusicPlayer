package music.hs.com.materialmusicv2.utils.drawableutils;
...
import music.hs.com.materialmusicv2.bottomsheetdialogs.BottomColorChooserSheetFragment;
import music.hs.com.materialmusicv2.bottomsheetdialogs.BottomFileChooserSheetFragment;
import music.hs.com.materialmusicv2.bottomsheetdialogs.BottomInputSheetFragment;
import music.hs.com.materialmusicv2.bottomsheetdialogs.BottomSeekbarInputSheetFragment;
import music.hs.com.materialmusicv2.bottomsheetdialogs.BottomSelectorSheetFragment;
import music.hs.com.materialmusicv2.bottomsheetdialogs.BottomYesNoSheetFragment;
...
import static music.hs.com.materialmusicv2.utils.queryutils.QueryUtils.addListToPlaylist;
...
import static music.hs.com.materialmusicv2.utils.queryutils.QueryUtils.getAllPlaylists;
...
public class DialogUtils {
    ...
    public static void showSeekbarInputDialog(MainActivity activity, int title, int message, int minInput, int maxInput, int isStop , OnInputListener onInputListener) {
        BottomSeekbarInputSheetFragment sheet = new BottomSeekbarInputSheetFragment(activity);
        sheet.setTitle(title);
        sheet.setYesText(R.string.yes);
        sheet.setNoText(R.string.cancel_label);
        sheet.setVisible(isStop);
        ...
        sheet.setCallback(new BottomSeekbarInputSheetFragment.Callback() {
           ...
           @Override
            public void onStopSelected() {
                postToast("Timer is off",activity,TOAST_SUCCESS);
                Controller.setTimer(Long.MAX_VALUE);
                Controller.pauseOrResumePlayer();
                activity.stopTimer();
            }
