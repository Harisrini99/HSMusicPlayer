...
import music.hs.com.materialmusicv2.adapters.MostPlayedAdapter;
import music.hs.com.materialmusicv2.adapters.SongAdapter;
import music.hs.com.materialmusicv2.adapters.SongDragAdapter;
import music.hs.com.materialmusicv2.customviews.others.BottomPlaybackController;
import music.hs.com.materialmusicv2.objects.MostPlayedList;
...
import static music.hs.com.materialmusicv2.utils.controller.Controller.hasPlaybackStartedEvenOnce;
...
public class GenrePlaylistActivity extends MusicPlayerActivity {
    ...
    ExtendedFloatingActionButton shuffleAll;

    @BindView(R.id.playlistImage)
    ImageView playlistImage;

    @OnClick({R.id.add, R.id.shuffleAll})
    ...
    public void loadAll() {
        ...
        setColorFilter(contrastColorAccent, shuffleAll);
        ...
        if (!songs.isEmpty()) {
            if (whatToDo == 5) {
                ...
                songAdapter = new SongAdapter(songs, GenrePlaylistActivity.this, false,false);
    ...
    public void onEvent(CurrentPlayingSong currentPlayingSong) {
        if (whatToDo == 3 && recyclerView != null && mostPlayedAdapter != null) {
            Song song = HSMusicApplication.getInstance().getPlayingQueueManager().getCurrentSong();
