package music.hs.com.materialmusicv2.utils.queryutils;
...
import music.hs.com.materialmusicv2.utils.blacklist.BlacklistStore;
...
public class QueryUtils {
    ...
    public static ArrayList<Song> getAllSongs(ContentResolver contentResolver, String sortOrder) {
        ...
        ArrayList<String> paths = BlacklistStore.getInstance(HSMusicApplication.getInstance().getApplicationContext()).getPaths();
        if (!paths.isEmpty()) {
