package music.hs.com.materialmusicv2.utils.artistutils;
...
import music.hs.com.materialmusicv2.methodcalls.MethodCalls;
...
public class ArtistUtils {
    public static String getArtistBioFromNameAndID(String artistName, long id) {
        try {
            ...
            Context context = HSMusicApplication.getInstance().getApplicationContext();
