...
import music.hs.com.materialmusicv2.service.PlayingQueueManager;
import music.hs.com.materialmusicv2.utils.languageutils.LocaleHelper;
import music.hs.com.materialmusicv2.utils.mediasessionutils.MediaSessionUtils;
import music.hs.com.materialmusicv2.utils.misc.Statics;
import music.hs.com.materialmusicv2.utils.preferenceutils.PreferenceUtils;
import music.hs.com.materialmusicv2.widgets.WidgetUtils;

import static music.hs.com.materialmusicv2.utils.misc.Etc.isMIUI;
import static music.hs.com.materialmusicv2.utils.queryutils.QueryUtils.createPlaylist;

public class HSMusicApplication extends Application implements BillingProcessor.IBillingHandler {
    ...
    private static HSMusicApplication symphonyApplication;

    public static HSMusicApplication getInstance() {
    ...
    public void onCreate() {
        ...
        AsyncTask.execute(() -> bp = new BillingProcessor(getApplicationContext(), getString(R.string.in_app_billing_api_key), HSMusicApplication.this));
