package music.hs.com.materialmusicv2.utils.misc;
...
public class Etc {
    ...
    public static boolean isConnectedToWifi() {
        ConnectivityManager connectivityManager = (ConnectivityManager) HSMusicApplication.getInstance().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
