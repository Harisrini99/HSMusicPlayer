...
import music.hs.com.materialmusicv2.customviews.others.CircleProgressBar;
...
import static music.hs.com.materialmusicv2.utils.bitmaputils.BitmapUtils.getRoundedSmallDrawable;
...
import static music.hs.com.materialmusicv2.utils.drawableutils.DrawableUtils.getPlayPauseResourceWhite;
import static music.hs.com.materialmusicv2.utils.drawableutils.DrawableUtils.getRepeatResourceWhite;
...
public class LibraryController extends LinearLayout implements View.OnClickListener {
    ...
    private void init() {
        inflate(getContext(), HSMusicApplication.getInstance().getPreferenceUtils().getMainScreenStyle() ? R.layout.library_controller_two : R.layout.library_controller_one, this);
    }
    ...
    protected void onFinishInflate() {
        ...
        if (songName != null && HSMusicApplication.getInstance().getPreferenceUtils().getMainScreenStyle()) {
