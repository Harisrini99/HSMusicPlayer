...
import music.hs.com.materialmusicv2.adapters.ArtistSongAdapter;
...
import static music.hs.com.materialmusicv2.utils.colorutils.ColorUtils.setBackgroundColor;
...
import static music.hs.com.materialmusicv2.utils.queryutils.QueryUtils.getAlbumsOfArtist;
...
public class ArtistActivity extends MusicPlayerActivity {
    ...
    @OnClick({R.id.playAll, R.id.artistName})
